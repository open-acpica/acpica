...
#define ACPI_KEYP_OFFSET(f)             (UINT16) ACPI_OFFSET (ACPI_TABLE_KEYP,f)
...
#define ACPI_MISC_OFFSET(f)             (UINT16) ACPI_OFFSET (ACPI_TABLE_MISC,f)
...
#define ACPI_UBRT_OFFSET(f)             (UINT16) ACPI_OFFSET (ACPI_TABLE_UBRT,f)
...
#define ACPI_KEYPH_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_KEYP_COMMON_HEADER,f)
#define ACPI_KEYP0_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_KEYP_CONFIG_UNIT,f)
#define ACPI_KEYP0A_OFFSET(f)           (UINT16) ACPI_OFFSET (ACPI_KEYP_RP_INFO,f)
...
#define ACPI_MISC0_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_MISC_GUID_ENTRY,f)
...
#define ACPI_UBRTS_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_UBRT_SUBTABLE,f)
#define ACPI_UBRTC_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_UBRT_HEADER,f)
#define ACPI_UBRT0_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_UBRT_UBC,f)
#define ACPI_UBRT0A_OFFSET(f)           (UINT16) ACPI_OFFSET (ACPI_UBRT_UBC_ENTRY,f)
#define ACPI_UBRT1_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_UBRT_UMMU,f)
#define ACPI_UBRT1A_OFFSET(f)           (UINT16) ACPI_OFFSET (ACPI_UBRT_UMMU_ENTRY,f)
#define ACPI_UBRT2_OFFSET(f)            (UINT16) ACPI_OFFSET (ACPI_UBRT_RESERVED_MEM,f)
#define ACPI_UBRT2A_OFFSET(f)           (UINT16) ACPI_OFFSET (ACPI_UBRT_MEM_RANGE,f)
...
#define ACPI_UBRT0_FLAG_OFFSET(f,o)     ACPI_FLAG_OFFSET (ACPI_UBRT_UBC,f,o)
#define ACPI_UBRT0A_FLAG_OFFSET(f,o)    ACPI_FLAG_OFFSET (ACPI_UBRT_UBC_ENTRY,f,o)
#define ACPI_UBRT2A_FLAG_OFFSET(f,o)    ACPI_FLAG_OFFSET (ACPI_UBRT_MEM_RANGE,f,o)
