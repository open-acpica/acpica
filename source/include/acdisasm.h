...
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtHeader[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtUbc[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtUbcEntry[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtUmmu[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtUmmuEntry[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtReservedMem[];
extern ACPI_DMTABLE_INFO        AcpiDmTableInfoUbrtMemRange[];
